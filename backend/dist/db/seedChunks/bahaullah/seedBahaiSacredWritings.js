...
const CHUNKS_DIR = path.resolve(__dirname, "../../../../../data/processed/bahaullah/bahai-sacred-writings");
...
function collectChunks(dir, relParts = [], author = DEFAULT_AUTHOR) {
    const entries = fs
    ...
    for (const entry of entries) {
        ...
        if (entry.isDirectory()) {
            ...
            const isAuthorFolder = relParts.length === 0 && (entry.name === "bahaullah" || entry.name === "abdulbaha");
            chunks.push(...collectChunks(fullPath, isAuthorFolder ? relParts : [...relParts, entry.name], isAuthorFolder ? entry.name : author));
        }
...
//# sourceMappingURL=seedBahaiSacredWritings.js.map