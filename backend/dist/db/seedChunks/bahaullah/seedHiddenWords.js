...
const CHUNKS_DIR = path.resolve(__dirname, "../../../../../data/processed/bahaullah/hidden-words");
const AUTHOR = "bahaullah";
const BOOK_TITLE = "the hidden words";
const SOURCE_URL = "https://www.bahai.org/library/authoritative-texts/bahaullah/hidden-words/1#623891128";
async function seed() {
...
//# sourceMappingURL=seedHiddenWords.js.map